% setup for Bunch Length Measurement for TCAV0
...
% Available screens
gBunchLength.screen = [];
gBunchLength.screen.a = {'OTR2','OTR4','YAGS1','YAGS2','OTR12'};

gBunchLength.screen.i = 1; % defaults to OTR2
...
gBunchLength.screen.pv.format = {'OTRS:IN20:571:%s', ... % OTR2
                                 'OTRS:IN20:711:%s', ... % OTR4
                                 'YAGS:IN20:921:%s', ... % YAGS1
                                 'YAGS:IN20:995:%s', ... % YAGS2
                                 'OTRS:LI21:291:%s'};    % OTR12
...
% TCAV
gBunchLength.tcav = [];
gBunchLength.tcav.name = 'TCAV0';
gBunchLength.tcav.bgrp_variable = 'T_CAV';
gBunchLength.tcav.aida = 'KLYS:LI20:51:TACT';
gBunchLength.tcav.pv.format = 'TCAV:IN20:490:%s';

gBunchLength.tcav.pdes.ts = cell(1);

gBunchLength.tcav.pdes.value = cell(1);
gBunchLength.tcav.pdes_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_PDES');
gBunchLength.tcav.pdes_pv.connected = 0;
gBunchLength.tcav.pdes_pv.force = {1};

gBunchLength.tcav.pdes.desc = cell(1);
gBunchLength.tcav.pdes.desc_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_PDES.DESC' );
gBunchLength.tcav.pdes.desc_pv.connected = 0;
gBunchLength.tcav.pdes.desc_pv.force = {1};

gBunchLength.tcav.pdes.egu = cell(1);
gBunchLength.tcav.pdes.egu_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_PDES.EGU' );
...
gBunchLength.tcav.pact_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_S_PV' );
gBunchLength.tcav.pact_pv.connected = 0;
gBunchLength.tcav.pact_pv.force = {1};

gBunchLength.tcav.pact.desc = cell(1);
gBunchLength.tcav.pact.desc_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_S_PV.DESC' );
gBunchLength.tcav.pact.desc_pv.connected = 0;
gBunchLength.tcav.pact.desc_pv.force = {1};

gBunchLength.tcav.pact.egu = cell(1);
gBunchLength.tcav.pact.egu_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_S_PV.EGU' );
...
gBunchLength.tcav.aact_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_S_AV' );
gBunchLength.tcav.aact_pv.connected = 0;
gBunchLength.tcav.aact_pv.force = {1};

gBunchLength.tcav.aact.desc = cell(1);
gBunchLength.tcav.aact.desc_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_S_AV.DESC' );
gBunchLength.tcav.aact.desc_pv.connected = 0;
gBunchLength.tcav.aact.desc_pv.force = {1};

gBunchLength.tcav.aact.egu = cell(1);
gBunchLength.tcav.aact.egu_pv.name{1} = sprintf(gBunchLength.tcav.pv.format, 'TC0_S_AV.EGU' );
...
gBunchLength.bpm = [];
gBunchLength.bpm.slc = 0; % All EPICS controlled BPMS
gBunchLength.bpm.a = {'BPM8','BPM9','BPM10','BPM11'}; % {} read from "MADN" secondary.
gBunchLength.bpm.i = 2; % default to BPM9
gBunchLength.bpm.pv.format = {'BPMS:IN20:511:%s', ... % BPM8
                              'BPMS:IN20:525:%s', ... % BPM9
                              'BPMS:IN20:581:%s', ... % BPM10
                              'BPMS:IN20:631:%s'};    % BPM11
...
% BPMS to read back during data collection cycle
% gBunchLength.bpm.rb.pv.format = { 'BPMS:IN20:425:%s', ... % BPM6
%                                   'BPMS:IN20:511:%s', ... % BPM8
%                                   'BPMS:IN20:525:%s', ... % BPM9
%                                   'BPMS:IN20:581:%s', ... % BPM10
%                                   'BPMS:IN20:631:%s' };   % BPM11
...
gBunchLength.fb(1).pv.name{1} = 'FBCK:INL0:1:ENABLE';
gBunchLength.fb(1).pv.connected = 0;
gBunchLength.fb(1).pv.force = {1};

gBunchLength.fb(2).ts = cell(1);
gBunchLength.fb(2).value = cell(1);
gBunchLength.fb(2).pv.name{1} = 'FBCK:INL1:1:ENABLE';
gBunchLength.fb(2).pv.connected = 0;
gBunchLength.fb(2).pv.force = {1};

gBunchLength.fb(3).ts = cell(1);
gBunchLength.fb(3).value = cell(1);
gBunchLength.fb(3).pv.name{1} = 'FBCK:LNG0:1:ENABLE';
gBunchLength.fb(3).pv.connected = 0;
gBunchLength.fb(3).pv.force = {1};

gBunchLength.fb(4).ts = cell(1);
gBunchLength.fb(4).value = cell(1);
gBunchLength.fb(4).pv.name{1} = 'FBCK:LNG1:1:ENABLE';
gBunchLength.fb(4).pv.connected = 0;
gBunchLength.fb(4).pv.force = {1};

gBunchLength.fb(5).ts = cell(1);
gBunchLength.fb(5).value = cell(1);
gBunchLength.fb(5).pv.name{1} = 'FBCK:LNG2:1:ENABLE';
gBunchLength.fb(5).pv.connected = 0;
gBunchLength.fb(5).pv.force = {1};

gBunchLength.fb(6).ts = cell(1);
gBunchLength.fb(6).value = cell(1);
gBunchLength.fb(6).pv.name{1} = 'FBCK:LNG3:1:ENABLE';
gBunchLength.fb(6).pv.connected = 0;
gBunchLength.fb(6).pv.force = {1};

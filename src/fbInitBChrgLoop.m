...
loop.check.wpPVs = {'FBCK:LR20:LS01:MOVE_CMPLT';...
                    'WPLT:IN20:181:VCC_ANGLE.MOVN'; 'WPLT:IN20:181:VCC_ANGLE.DMOV'};
%loop.check.wpPVs = {'WPLT:LR20:116:WP2_ANGLE.MOVN'; 'WPLT:LR20:116:WP2_ANGLE.DMOV';...
%                    'WPLT:IN20:181:VCC_ANGLE.MOVN'; 'WPLT:IN20:181:VCC_ANGLE.DMOV'};
...
% set up the eDef for the bunch charge measurements %2020 use BR
...
loop.meas.chosenmeasPVs = fbAddToPVNames(loop.meas.chosenmeasPVs,'HSTBR');

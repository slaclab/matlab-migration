function stat=LEM_xalBnchWrite()
%
...
% copy some things from KLYS structure into local arrays

kName=char(KLYS.name);
kPower=reshape([KLYS.power],4,[])';
kStat=[KLYS.stat]';
kAmpl=[KLYS.ampl]';
kPhas=reshape([KLYS.phas],2,[])';
kFudge=[KLYS.fudge]';

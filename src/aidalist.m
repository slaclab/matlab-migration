...
%  aidalist lists the names of Control System quantities known to AIDA. 
%
...
%  triggers etc.
%
%  Since AIDA can acquire data form many kinds of data source, not
%  just EPICS, the interpretation of instance and attribute will
%  vary. The following gives some examples of AIDA names.
%
...
%  etc. See http://www.slac.stanford.edu/grp/cd/soft/aida/. To test
...
command = sprintf('aidalist %s %s', instance, attribute);
...
% with //, to make an acquirable AIDA name of the syntax

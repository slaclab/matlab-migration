function girderBPMMove(segmentList, dx, dy)
%
% Move the bpm in the segment list by dx, and dy, while keeping the
% BFW in the present position. 
%
...
dpa(:,1) = dx;
dpa(:,2) = dy;
dpa(:,3) = geo.bpmz; % bpm axis point

dpb(:,3) = geo.bfwz; % bfw axis point

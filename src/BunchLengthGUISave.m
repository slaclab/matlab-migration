...
if isequal(gBunchLength.fileName,0)
    ...
    BunchLengthLogMsg(sprintf('Request to save data set to %s. Please wait.', gBunchLength.fileName));
    BunchLengthSave(fullfile(gBunchLength.pathName, gBunchLength.fileName));
end
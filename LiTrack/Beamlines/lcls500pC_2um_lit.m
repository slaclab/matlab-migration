...
% ============================================================================================
inp = 'lcls500pc_650um.zd';		% name of file with 2-columns [Z/mm dE/E/%] (sigz0 and sigd0 below not used in this case)
...
Ne     = 0.625E10*0.5;	% number of particles initially in bunch
...
beamline = [...
 ...
 -11   	0.140301  -1.000000   0.104969 1          6.100000
  6   	0.010400   0.220000   0.150000 0 0
 -11   	0.13097  -40.0			0.104969 1          8.800000
% -11   	0.010000 -180.000000  0.026242 2          0.591162
  7  	-0.040     0.250	  	0	 0		0
 -11   	5.8222	 -42.3	      0.104969 1        328.918867
%  22   	3.00E-5		    0		    0		    0		    0
  7  	-0.0234   4.539266  	0 		0 			0
 -22   	0.80E-5		    0		    0		    0		    0
  11   	9.948387  -8.085354   0.104969 1        553.041370

...
Ne     = 2.20E10*(1+0.0390);	% number of particles initially in bunch
%Ne     = 2.20E10*(1+0.0024);	% number of particles initially in bunch
%z0_bar = 0.000E-3;	% axial offset of bunch [m] (used also with file input - mean of file removed first)
%z0_bar = -0.3402E-3;	% axial offset of bunch [m] (used also with file input - mean of file removed first)
z0_bar =  0.0257E-3;	% axial offset of bunch [m] (used also with file input - mean of file removed first)
d0_bar = 0.000E-2;	% relative energy offset of bunch [ ]  (used also with file input - mean of file removed first)
Nbin   = 150;		% number of bins for z-coordinate (and dE/E for plots)
...
comment = 'FFTB Compression to 30 kA at 29 GeV';	% text comment which appears at bottom of plots
...
beamline = [
  -11.0000         0         0    0.1050         0         0
  -11.0000    0.0408   92.1190    0.1050    1.0000    2.1300
   26.0000   -0.0240    0.0240         0         0         0
   -6.0000    0.6030    1.0535    1.1885         0         0
   11.0000    7.9316  -20.1214    0.1050    1.0000  450.3000
   11.0000         0         0    0.1050    1.0000  194.8000
  -11.0000    0.5198  -19.9407    0.1050    1.0000  127.9000
    7.0000   -0.0745    9.0000         0         0         0
   22.0000    0.0001         0         0         0         0
  -37.0000    0.0100    1.0000         0         0         0
   11.0000   10.8523   -3.9404    0.1050    1.0000  602.5000
   11.0000    1.7532   16.2200    0.1050    1.0000   97.4000
   11.0000    1.7532  -24.7600    0.1050    1.0000   97.4000
   11.0000    0.8604   -4.0000    0.1050    1.0000   47.8000
   11.0000    2.1368   -3.7965    0.1050    1.0000  118.7000
   11.0000         0         0    0.1050    1.0000  578.4000
   11.0000    1.7532   16.2200    0.1050    1.0000   97.4000
   11.0000    1.5894  -27.0600    0.1050    1.0000   88.3000
  -11.0000         0         0    0.1050    1.0000  178.6000
    6.0000    0.0020    0.0040   28.5000         0         0
   22.0000    0.0000         0         0         0         0
   37.0000    0.0100    1.0000         0         0         0
  -99.0000         0         0         0         0         0
%
%  -11.0000         0         0    0.1050         0         0
%  -11.0000    0.0408   91.9204    0.1050    1.0000    2.1300
%   26.0000   -0.0240    0.0240         0         0         0
%   -6.0000    0.6030    1.0535    1.1885         0         0
%   11.0000    7.9418  -19.7579    0.1050    1.0000  450.3000
%   11.0000         0         0    0.1050    1.0000  194.8000
%  -11.0000    0.5198  -19.8953    0.1050    1.0000  127.9000
%    7.0000   -0.0745    9.0000         0         0         0
%   22.0000    0.0001         0         0         0         0
%  -37.0000    0.0100    1.0000         0         0         0
%   11.0000   10.8440   -3.9607    0.1050    1.0000  602.5000
%   11.0000    1.7532   16.2200    0.1050    1.0000   97.4000
%   11.0000    1.7532  -24.7600    0.1050    1.0000   97.4000
%   11.0000    0.8604   -4.0000    0.1050    1.0000   47.8000
%   11.0000    2.1343   -4.0777    0.1050    1.0000  118.7000
%   11.0000         0         0    0.1050    1.0000  578.4000
%   11.0000    1.7532   16.2200    0.1050    1.0000   97.4000
%   11.0000    1.5894  -27.0600    0.1050    1.0000   88.3000
%  -11.0000         0         0    0.1050    1.0000  178.6000
...
%  -99.0000         0         0         0         0         0
%       	   -11		0		    0		    0.104969	0		  0
%       	   -11		0.0408	   92.0		    0.104969	1		  2.13
%            26	    -0.024		0.024		0		    0		  0
%            -6		0.603       1.0535		1.1885		0		  0
%		    11		7.9398	  -20.0		    0.104969	1		450.3
%		    11		0.0	        0		    0.104969	1		194.8
%		   -11		0.5198	  -20.0		    0.104969	1		127.9
%			 7	   -0.0745      9.000	    0           0         0
%            22      5.6E-5      0           0           0         0
%		   -37		0.01		1		    0		    0		  0
%		    11     10.8450     -4.          0.104969    1       602.5
%		    11      1.7532     16.22        0.104969    1        97.4
%		    11      1.7532    -24.76        0.104969    1        97.4
%		    11      0.8604     -4.          0.104969    1        47.8
%		    11      2.1366     -4.          0.104969    1       118.7
%		    11      0.0         0.          0.104969    1       578.4
%		    11      1.7532     16.22        0.104969    1        97.4
%		    11      1.5894    -27.06        0.104969    1        88.3
%		   -11      0.0         0.          0.104969    1       178.6

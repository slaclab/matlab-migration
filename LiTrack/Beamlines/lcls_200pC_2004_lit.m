...
% ============================================================================================
inp = 'lcls_200pC_6MeV_436um.zd';
%inp = 'lcls_200pC_6MeV_561um.zd';
%inp = 'LCLS_fake200pC_6MeV.zd';	% name of file with 2-columns [Z/mm dE/E/%] (sigz0 and sigd0 below not used in this case)
%inp = 'LCLS24MAR04_6MeV.zd';	% name of file with 2-columns [Z/mm dE/E/%] (sigz0 and sigd0 below not used in this case)
%sz_scale = 0.767;				% =-1: reverse sign of z-coordinate in input file
%sz_scale = 0.517;				% =-1: reverse sign of z-coordinate in input file
...
beamline = [...
 -11	0.0  	    	0.0			0.104969	0          	0.1
  11    0.13065			 -8.75  	0.104969 	1          	6.1
%  11    0.13010			 -7.0  		0.104969 	1          	6.1
  22   	2.00E-4		    0		    0		    0		    0
 -6   	0.0063   	    0.140   	0.135000 	0		    0
 -11   	0.148021 		-24.1   	0.104969 	1          	8.8
 -11   	0.0214			-160   		0.026242 	2          	0.60
 -7  	-0.0420			0.2500  	0           0           0
 -11   	5.46619			-42.1   	0.104969 	1        	329
  7  	-0.0194			4.3000		0       	0           0
 -22   	0.80E-5		    0		    0		    0		    0
  11   	9.41403 		-6.6   		0.104969 	1        	553

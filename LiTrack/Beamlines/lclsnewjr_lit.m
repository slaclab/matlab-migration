...
% ============================================================================================
inp = 'thermal1_jr.zd';		% name of file with 2-columns [Z/mm dE/E/%] (sigz0 and sigd0 below not used in this case)
...
plot_frac = 0.33;		% fraction of particles to plot in the delta-z scatter-plots (0 < plot_frac <= 1)
%E0     = 0.14336;		% initial electron energy [GeV]
E0     = 0.15000;		% initial electron energy [GeV]
Ne     = 0.625E10;		% number of particles initially in bunch
z0_bar = -0.300E-3;		% axial offset of bunch [m] (used also with file input - mean of file removed first)
...
beamline = [...
		-11	0	0		0.1050		0		0
		-6	0.0104	0.2197		0.1500		0		0
		-11	0.1572	-40.0		0.1050		1		8.782
		-11	0.0200	-180.0000	0.1050/4	2		0.5
		-6	-0.0290	0.0290*1.5	0.2500		-0.0290*2	0
		-11	5.2050	-34.0		0.1050		1		331.8
		6	-0.0296	0.0296*1.5	4.5400		-0.0296*2	0
		-22	1.05E-5	0		0		0		0
		11	9.8826	0.0		0.1050		1		556.1

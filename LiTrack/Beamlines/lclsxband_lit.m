...
% ========================================================================================================
sigz0 = 0.830E-3;		% rms bunch length used when inp=G or U above [m]
...
plot_frac = 0.01;		% fraction of particles to plot in the delta-z scatter-plots (0 < plot_frac <= 1)
...
d0_bar = 0.0E-2;		% relative energy offset of bunch [ ]  (used also with file input - mean of file removed first)
...
% STOP	       | code=99          -             -           -               -               -
%===============================================================================================================
%Etol=0.6913 ps, Etolq=30.5345 %, Ztol=4.1907 ps, Ztolq=5.2123 % (23-Oct-00, R56{DL2}=0)
%===============================================================================================================
beamline = [...
 11   0		0		0.1050		0	0
 11   0.1406  	-1.500000   	0.105000 	1	6.09
  6   0.010400   0.220000   	0.150000   	0.0	0
%-11   0.13791 	-43.1   	0.105000 	1	8.78
-11   0.15262 	-39.0   	0.105000 	1	8.78
-11   0.0180 	-180.0   	0.026250 	2	0.6
%%-11   0.15581 	-38.1   	0.105000 	1	8.78
%%-11   0.0220 	-180.0   	0.026250 	2	0.6
  7  	-0.0355 	    0.2500  	0           0           0
 99   0		0		0		0	0
 11   5.8923 	-42.90		0.105000	1	329
  6  -0.0222   	0.0222*1.5	4.540	-0.0222*2	0
-22   0.80E-5	0		0		0	0
 11   10.0318	-10.0		0.105000	1	553
 11   0.0	0.0		0.105		5	70
 11   0.0	0.0		0.105		6	100
  6   0.0000	0.0730		14.350   	0.0 	0
 22   1.32E-5	0		0		0	0
-27   0.020	0		0		0	0
 99   0		0		0		0	0
								];

...
Nesim = 500000;		% number of particles to generate for simulation when inp=G or U (reasonable: ~1000 to ~100000)
...
Nbin   = 400;		% number of bins for z-coordinate (and dE/E for plots)
...
comment = 'FFTB Compression to 30 kA at 27.3 GeV';	% text comment which appears at bottom of plots
...
beamline = [
		   ...
		   -11		8.4596	   20.		    0.104969	1		773.0+12.2
			 7	   -0.0750      9.000	    0           0         0
            22      5.6E-5      0           0           0         0
		   -37		0.01		1		    0		    0		  0
		   -11     19.5770    -15.          0.104969    1      1906.5-12.2
            6		0.0020      0.004      27.28 		0		  0
            22      0.8E-5      0           0           0         0
		    37		0.01		1		    0		    0		  0
		   -99		0		    0		    0		    0		  0
                                                                            ];

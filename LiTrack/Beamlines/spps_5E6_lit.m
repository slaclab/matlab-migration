...
Nesim = 5000000;	% number of particles to generate for simulation when inp=G or U (reasonable: ~1000 to ~100000)
...
plot_frac = 0.002;   % fraction of particles to plot in the delta-z scatter-plots (0 < plot_frac <= 1)

...
% ========================================================================================================
sigz0 = 5.5E-3;	    % rms bunch length used when inp=G or U above [m]
sigd0 = 0.070E-2;	% rms relative energy spread used when inp=G or U above [ ]
Nesim = 50000;		% number of particles to generate for simulation when inp=G or U (reasonable: ~1000 to ~100000)
asym  = -0.20;		% for inp='M' or 'G': sets rise/fall time width (-1<asym<1)
...
Ne     = 1.00E10;	% number of particles initially in bunch
...
comment = 'E164 100-um bunch at 1E10, 28.5 GeV';	% text comment which appears at bottom of plots
...
beamline = [
       	   -11		0		    0		    0.104969	0		  0
       	   -11		0.0360	   90.0		    0.104969	1		  2.13
            26	    -0.020		0.020		0		    0		  0
            -6		0.603       1.0535		1.190		0		  0
%		   -11		8.422	  -19.2		    0.104969	1		815.6
		   -11		9.000	  -22.0		   -0.104969	1		815.6
			 7	   -0.0760      9.000	    0           0         0
            22      5.9E-5      0           0           0         0
 		   -37		0.01		1		    0		    0		  0
%		   -11     20.040       0.          0.104969    1      1869.9
		   -11     21.040     -20.          0.104969    1      1869.9
            6		0.0014      0.004      28.50 		0		  0
            22      0.8E-5      0           0           0         0
 		    37		0.01		1		    0		    0		  0
		   -99		0		    0		    0		    0		  0
                                                                            ];

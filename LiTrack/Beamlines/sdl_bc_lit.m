...
% ============================================================================================
inp = 'sdl_gun.zd';	% name of file with 2-columns [Z/mm dE/E/%] (sigz and sigd not used in this case)
...
% ========================================================================================================
sigz0 = 0.700E-3;	% rms bunch length used when inp=G or U above [m]
...
E0     = 0.005745;	% initial electron energy [GeV]
...
Nbin   = 40;		% number of bins for z-coordinate (and dE/E for plots)
...
comment = 'SDL Bunch Compressor (6/17/99)';	% text comment which appears at bottom of plots
...
%=============================================================================================================
beamline = [
			11		0.040900	0.00		0.1050		1		3.0
			11		0.04286 	-38.00		0.1050		1		3.0
                        6		-0.05320	0.0532*1.5	0.0802		-0.0532*2	0
%                        -27		0.01		0		0		0		0
			-11		0.130000	+10.00		0.1050		1		6.
			99		0		0		0		0		0
                            											];

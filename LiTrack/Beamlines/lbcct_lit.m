...
plot_frac = 0.15;   % fraction of particles to plot in the delta-z scatter-plots (0 < plot_frac <= 1)
E0     = 1.19;		% initial electron energy [GeV]
Ne     = 2.31E10;	% number of particles initially in bunch
...
%		   -10		9.000	  -20.1		    0.104969	1		809.5
		   -10		9.000	  -20.0		    0.104969	1		809.5
			 7	   -0.0760      9.000	    0           0         0
            22      5.9E-5      0           0           0         0
 		   -37		0.01		1		    0		    0		  0
		    11     20.1983     -0.          0.104969    0      1872.4
		   -99		0		    0		    0		    0		  0

...
% ============================================================================================
inp = 'lcls15ps_6MeV_200k.zd';	% name of file with 2-columns [Z/mm dE/E/%] (sigz0 and sigd0 below not used in this case)
...
% ========================================================================================================
sigz0 = 1.312E-3;		% rms bunch length used when inp=G or U above [m]
...
comment = 'LCLS05NOV03';				% text comment which appears at bottom of plots
...
beamline = [...
 -11	0.0  	    	0.000000   	0.104969	0          	0.1
 -11	0.12975  	    3.000000   	0.104969	1          	6.1
  22   	1.90E-4		    0		    0		    0		    0
 -6   	0.006300   	    0.140000   	0.135000 	0		    0
 -11   	0.14100 	    -18.0       0.104969 	1        	8.78
 -11   	0.020000 		-160.000000 0.026242 	2        	0.60
 -7  	-0.05400 	    0.250083  	0           0           0
 -11   	5.4680	 	    -38.00      0.104969 	1        	328.9
  7  	-0.0246   	    4.5400      0       	0           0
 -22   	0.80E-5		    0		    0		    0		    0
  11  	 9.780	    	-10.0      	0.104969 	1        	553.0
  11   	0.0		        0.0		    0.105		5		    76
  11   	0.0		        0.0		    0.105		6		    275
  6   	0.000133   	    0.006300  	14.10000 	0 		    0
 -22   	1.32E-5		    0		    0		    0		    0
  27   	0.020		    0		    0		    0		    0  
 -99   	0		        0		    0		    0		    0
	    								                                ];

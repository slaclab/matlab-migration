...
% ========================================================================================================
sigz0 = 0.005E-3;	% rms bunch length used when inp=G or U above [m]
...
E0     = 14.350000;	% initial electron energy [GeV]
...
wake_fn = ['slac.dat           '
           ...
           'SlacL.dat          '
           'Slac_cu_rw.dat     '
           'und2500um_cu_rw.dat'];	% name of point-charge wakefield file(s) ["slac.dat" is default if filename not given]

comment = 'RW test';		% text comment which appears at bottom of plots

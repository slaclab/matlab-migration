...
halo  = 0;			% for inp='G': sets a "halo_pop"-halo at halo*sigz
halo_pop  = 0.0;	% for inp='G': sets an N%-halo at halo*sigz (e.g. 0.01 is a 1% relative population)
% ========================================================================================================
...
Ne     = 0.755E10;	% number of particles initially in bunch
...
%			-6	-0.485		0.485*1.5	1.9518		-0.485*2	0
			-11	0.1137		-99.73		0.2100		3			10.0
			-6	-0.591		0.591*1.5	1.9608		-0.591*2	0
%			-11	6.1126		-6.000		0.1050		1			356.
			-11	6.0878		-4.000		0.1050		1			356.
			-6	+0.268		0.268*1.55	8.0000		0.268*2.5	0
			-11	0.5818		-102.22		0.0262		2			14.4
			 6	-0.049		0.049*1.5	7.8760		-0.049*2	0
			-37	0.00200		0			0			0			0
%			11	540.86		-10.00		0.0262		2			9000.
			11	539.28		-9.00		0.0262		2			9000.
			37	0.0050		0			0			0			0
			99	0			0			0			0			0
                            										];

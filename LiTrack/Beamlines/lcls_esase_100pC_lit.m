...
%sz_scale = -0.47;				% =-1: reverse sign of z-coordinate in input file
...
% ========================================================================================================
sigz0 = 0.390E-3;		% rms bunch length used when inp=G or U above [m]
sigd0 = 5.000E-4;		% rms relative energy spread used when inp=G or U above [ ]
...
Ne     = 0.625E10/10;	% number of particles initially in bunch
...
comment = '100 pC ESASE';				% text comment which appears at bottom of plots
...
% Z-window cut | code=35     z-full-width   z_plot-width	-               -               -
...
beamline = [...
 -11	0.0  	    	0.0			0.104969	0          	0.1
  11	0.1291  	   -1.10		0.104969	1          	6.1
  22   	0.60E-4		    0		    0		    0		    0
 -6   	0.0063   	    0.140   	0.135000 	0		    0
 -11	0.1476			-25.0		0.104969	1			8.78
 -11	0.0200			-160.0		0.026242	2			0.60
 -7  	-0.03905		0.2500  	0           0           0
 -11	2.5995			-30.0		0.104969	1			180.0
 -7  	-0.023			2.500		0       	0           0
  22   	0.40E-5		    0		    0		    0		    0
 -45    1.4E-3			800E-9		0			0			0
 -11	11.612			0			0.104969	1			709.0
  11   	0.0		        0.0		    0.105		5		    105
  11   	0.0		        0.0		    0.105		6		    275
%  6   	0.000133   	    0.0063		14.100		0 		    0
  6     0.000560   	    0.0000		14.100		0 		    0
  22   	1.32E-5		    0		    0		    0		    0
 -27   	0.020		    1		    0		    0		    0
  35    1.2E-6			0.3e-6		0			0			0
 -99   	0		        0		    0		    0		    0
	    								                                ];

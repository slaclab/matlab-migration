...
Nesim = 400000;		% number of particles to generate for simulation when inp=G or U (reasonable: ~1000 to ~100000)
% ========================================================================================================
...
Ne     = 3.80E10;	% number of particles initially in bunch
...
Nbin   = 250;		% number of bins for z-coordinate (and dE/E for plots)
...
comment = 'SLC Arc Compression Test';	% text comment which appears at bottom of plots
...
beamline = [
			11		0.03550		90.0		0.104969	0		2.13
            26		-0.0225		0.0225		0		0		0
            -6		0.603   	1.162		1.19		0		0
		   -11		31.0964		-24.0		0.104969	1		2733.
			6		0.009412  	0.01788		28.5		0		0
			22		1.8074E-4*0.343 0		0		0		0
			6		0.009412  	0.01788		28.5		0		0
			22		1.8074E-4*0.343 0		0		0		0
			6		0.009412  	0.01788		28.5		0		0
			22		1.8074E-4*0.343 0		0		0		0

...
Ne     = 0.95E10;	% number of particles initially in bunch
...
comment = 'NLC ZDR Bunch Compressor System (4/16/99)';	% text comment which appears at bottom of plots
...
%=============================================================================================================
beamline = [
			11		0.13900		-101.00		0.2100		0		16.0
			6		-0.4800		0.72000		1.9540		0		0
			11		8.14810		-7.0000		0.1050		1		396.
			6		+0.1840		0.35000		10.0000		0		0
			22		6.00E-5		0		0		0		0
			11		4.00000		-86.250		0.1050		1		200.0
			-11		0.27500		-180.00		0.0262		0		5.40
			6		-0.0340		0.05100		10.0000		0		0
			22		1.50E-5		0		0		0		0
			11		539.959		-12.0000	0.0262		2		8900.
			-99		0		0		0		0		0
			25		0.01000		0		0		0		0
														];

...
%inp = 'M';			% general Z and dE/E (see sigz0 =..., sigd0 =...[note: FW = sig*sqrt(12)]
...
asym  = 0.00;		% for inp='M' or 'G': sets rise/fall time width (-1<asym<1)
tail  = 0.00;		% for inp='M' or 'G': sets rise/fall time width (0<=tail<1)
cut   = 10.0;		% for inp='G': sets rise/fall time width (0.5<=cut<inf)
% ========================================================================================================

E0     = 1.000;		% initial electron energy [GeV]
Ne     = 1.122E10;	% number of particles initially in bunch
...
Nbin   = 50;		% number of bins for z-coordinate (and dE/E for plots)
...
comment = 'LiTrack skeleton file';	% text comment which appears at bottom of plots
...
%=============================================================================================================
beamline = [
		-11	0.00000	-0.00		0.1050	1		10.0
		6	-0.0300	0.0300*1.5	1.0000	-0.0300*2	0
		11	1.00000	-5.000	0.1050	1		100.
		-99	0		0		0		0		0
                            											];

...
% ========================================================================================================
sigz0 = 0.376E-3;		% rms bunch length used when inp=G or U above [m]
sigd0 = 0.020E-2;		% rms relative energy spread used when inp=G or U above [ ]
...
cut   = 1.0;			% for inp='G': cuts the gaussian (0.5<=cut<inf)
% ========================================================================================================
...
comment = '200 pC w/X-band';	% text comment which appears at bottom of plots
...
%===============================================================================================================
beamline = [...
  11   0.143108  -1.000000   0.104969 1          6.100000
 -6   0.010400   0.220000   0.150000 0 0
 -11   0.137413 -33.847019   0.104969 1          8.800000
 -11   0.014088 -180.000000   0.026242 2          0.605623
 -6  -0.047464   0.071197   0.249869  -0.047464*2 0
 -11   4.885652 -28.453131   0.104969 1        328.908145
 -6  -0.033965   0.050947   4.538671  -0.033965*2 0
 22   1.10E-5	0		0		0	0
  11   9.847189  -3.901057   0.104969 1        553.074915

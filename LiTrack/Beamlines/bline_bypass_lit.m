...
wake_fn = ['slac.dat         '
           ...
           'SS_12700um_rw.dat'
           'Al_12700um_rw.dat'
		   'SS_25400um_rw.dat'];		% name of point-charge wakefield file(s) ["slac.dat" is default if filename not given]

comment = 'New B-Line SPPS-Like Bunch Compressor (10-Sep-2004 - PE)';	% text comment which appears at bottom of plots
...
beamline = [
		   ...
		   -10		9.000	  -20.0		    0.104969	1		809.5
%		   -13		9.000	   0.235       -90.0	    90.0      0.104969
			 7	   -0.0760      9.000	    0           0         0
            22      5.9E-5      0           0           0         0
 		   -37		0.02		1		    0		    0		  0
		   -10     28.500      -1.0         0.104969    1      1872.4/2
             6		0*0.0643      2*0.783      28.50 		0		  0
		    99		0		    0		    0		    0		  0
%            6		0.00232     0.035      28.50 		0		  0
		   -11      0.000       0.0         0.104969    7      1000
            6		0.00300     0.077      28.50 		0		  0
            22      1.0E-4      0           0           0         0
 		    37		0.01		1		    0		    0		  0
		    99		0		    0		    0		    0		  0
                                                                            ];

...
% ========================================================================================================
sigz0 = 0.590E-3;		% rms bunch length used when inp=G or U above [m]
...
Ne     = 0.625E10*0.25;		% number of particles initially in bunch
...
comment = 'LCLS CDR-version (25OCT00)';	% text comment which appears at bottom of plots
...
%==============================================================================================================
beamline = [...
  11   0.140141  -1.500000   0.104969 1          6.100000
  6   0.010400   0.220000   0.150000 0 0
  11   0.140784 -34.420555   0.104969 1          8.800000
  11   0.016023 -180.000000   0.026242 2          0.602516
  6  -0.046842   0.070264   0.249933  -0.046842*2 0
  11   5.122303 -32.936453   0.104969 1        329.053119
  6  -0.025434   0.038151   4.540626  -0.025434*2 0
  22   	0.80E-5		0		0		0		0
  11   9.906215  -7.317482   0.104969 1        552.964736

...
% ========================================================================================================
sigz0 = 6.000E-3;	% rms bunch length used when inp=G or U above [m]
...
asym  = +0;		    % for inp='M' or 'G': sets rise/fall time width (-1<asym<1) 0 is no asym
tail  = 0.;		    % for inp='M' or 'G': sets rise/fall time width (0<=tail<1) 0 is no tail
cut   = 10.;		% for inp='G': sets rise/fall time width (0.5<=cut<inf)
% ========================================================================================================
...
Nbin   = 100;		% number of bins for z-coordinate (and dE/E for plots) REDUCE THIS FOR SPEED
...
comment = '30 GeV 1 nC Test Beam Bunch Compressor System ';	% text comment which appears at bottom of plots
...
%=============================================================================================================
beamline = [
		-11		0.038		90.0		0.1050		0		2.1
		-6		0.603		0.603*1.8	1.190		0.0		0
		27		0.0050		0		    0		    0		0
		-11		3.600		-22.0		0.1050		1		300.
        -6		-0.056	    0.056*1.5	4.519	-0.056*2	0
       -11		27.64  	    -22.0		0.1050		1		2433.
%        -6		 0.020	    0.020*1.5	30.0	-0.020*2	0
        37		0.0200		0		    0		    0		0
		99		0		    0		    0		    0		0
                            										];

...
% ============================================================================================
%inp = 'sparx_10ps_mc.zd';	% name of file with 2-columns [Z/mm dE/E/%] (sigz and sigd not used in this case)
...
tail  = 0.5;		% for inp='M' or 'G': sets rise/fall time width (0<=tail<1)
...
%E0     = 0.15531;	% initial electron energy [GeV]
E0     = 0.007;	% initial electron energy [GeV]
...
beamline = [
 -11   0	      0		   	 0.104969 0          0
 -11   0.143344  -1.500000   0.104969 1          6.000000
 -11   0.241086 -23.6        0.104969 1         12.000000
 -11   0.019977 -180.000000  0.026242 2          0.603387
 -6  -0.050      0.050*3/2   0.349887  -0.050*2 0
 -11   0.1694   -22.0        0.104969 1         33.355372
 -6  -0.021329   0.031994    0.501044  -0.021329*2 0
 -11   2.007602   0.009216   0.104969 1         78.159165
  27   0.02			0			0		0			0
 -99   	0		    0		    0		0		    0
                                                                            ];

% -11	0.0    			 0.0  		0.104969	0          	0.0
% -11	0.2408    		-23.60  	0.104969	1          	12.0
% -7    -0.0550   	     0.3513   	0 			0		    0
% -11	0.6622    		-22.0  		0.104969	1          	33.1
% -7    -0.021   	     0.966   	0 			0		    0

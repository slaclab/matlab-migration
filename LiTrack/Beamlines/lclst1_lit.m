...
sigd0 = 0.100E-2*10/150;	% rms relative energy spread used when inp=G or U above [ ]
...
E0     = 0.150000;	% initial electron energy [GeV]
Ne     = 0.625E10;	% number of particles initially in bunch
z0_bar = -0.292E-3;	% axial offset of bunch [m] (used also with file input - mean of file removed first)
...
beamline = [...
		-11	0		0		0.1050		0		0
		-11.0	0.1331		-41.00		0.1050		1		8.782
		6.00	-0.0306		0.0306*1.5	0.2500		-0.0306*2	0
		-11.0	5.2042		-34.00		0.1050		1		332.
		6.00	-0.0304		0.0304*1.5	4.5400		-0.0304*2	0
		11.0	10.0230		-10.00		0.1050		1		556.0
                -27	0.020		0		0		0		0
                99	0		0		0		0		0
         												];

...
Ne     = 3.00E10;	% number of particles initially in bunch
...
comment = 'SLC FFTB Compression Test';	% text comment which appears at bottom of plots
...
beamline = [
			11		0.0350		90.0		0.104969	0		2.13
            26	    -0.0225		0.0225		0		    0		0
            -6		0.603   	1.162		1.19		0		0
			-11		5.00		0.0		    0.104969	1		477.
			-6		0.0200  	0.030		6.028		0.040	0
			-11		25.21		-10.0		0.104969	1		2256.
			6		0.0082  	0.012		30.0		0.016	0
			22		0.5E-4      0		    0		    0		0
			36		-0.0005     0.0005	    0		    0		0
			-99		0		    0		    0		    0		0
                            											];

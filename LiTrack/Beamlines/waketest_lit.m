...
% ========================================================================================================
sigz0 = 0.001E-3;	% rms bunch length used when inp=G or U above [m]
...
asym  = 0;			% for inp='M' or 'G': sets rise/fall time width (-1<asym<1)
...
E0     = 0.10;		% initial electron energy [GeV]
...
wake_fn = ['slac.dat         '
           ...
           'SS_12700um_rw.dat'
           'Al_12700um_rw.dat'
		   'TESLA.dat        '];		 % name of point-charge wakefield file(s) ["slac.dat" is default if filename not given]

comment = 'Wake test';	% text comment which appears at bottom of plots
...
beamline = [
       	   -11		0		    0		    0.104969	0		  0
		   -10		15.000	  0.0		    0.230000	1		  800
%		    11		0.001	  0.0		    0.230000	5		  150
		   -99		0		    0		    0		    0		  0
                                                                            ];

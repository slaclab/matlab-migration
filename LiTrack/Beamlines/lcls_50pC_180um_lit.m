...
% ============================================================================================
inp = 'lcls_200pC_6MeV_560um.zd';
%inp = 'LCLS24MAR04_6MeV.zd';	% name of file with 2-columns [Z/mm dE/E/%] (sigz0 and sigd0 below not used in this case)
sz_scale = 0.3214;				% =-1: reverse sign of z-coordinate in input file
%sz_scale = 0.5357;				% =-1: reverse sign of z-coordinate in input file
...
Ne     = 0.625E10*0.05;	% number of particles initially in bunch
...
comment = '100-pC, 2.0 kA, 0.85 mm-mrad';		% text comment which appears at bottom of plots
...
beamline = [...
 -11	0.0  	    	0.0			0.104969	0          	0.1
  11    0.13019			-7.7 		0.104969 	1          	6.1
  22   	1.2E-4		    0		    0		    0		    0
 -6   	0.0063   	    0.140   	0.135000 	0		    0
 -11   	0.14562	 		-23.1   	0.104969 	1          	8.8
 -11   	0.0200			-160   		0.026242 	2          	0.60
 -7  	-0.0442			0.2500  	0           0           0
 -11   	5.21775			-39.0   	0.104969 	1        	329
  7  	-0.0208			4.3000		0       	0           0
 -22   	0.80E-5		    0		    0		    0		    0
  11   	9.444503 		-8.4   		0.104969 	1        	553

function [] = startapex_nominal(JumpFlag) % FS April 9, 2014
...
if JumpFlag==0
    ...
    % set some llrf parameters to nominal value.
...
setpv('llrf1:ddsa_phstep_l_ao',4092);%Set initial frequency fine
setpv('llrf1:ddsa_modulo_ao',4);

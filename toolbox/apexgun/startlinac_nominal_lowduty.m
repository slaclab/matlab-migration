function [] = startlinac_nominal_lowduty % FS January 8, 2016
...
InitialPulseLength_ms=0.014; %pulselenght in ms
FinalPulseLength_ms=0.014; %pulselenght in ms *****DO NOT CHANGE THIS VALUE*****
PulseSteps=1;% number of steps in increasing the pulse lenght
...
setpv('L2llrf:pulse_length_ao', InitialPulseLength_ms*1e5*TimeScaleCalFactor); % set initial pulse lenght.

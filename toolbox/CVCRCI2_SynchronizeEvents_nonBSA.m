if(Init_Vars.NumberOfSynchPVs)
          ...
          if(CycleVars(1).Run_Post_Processing)
              IntersectPid=unique(ProcessedData(1).PulseID,'stable');
          else
      ...
      if(NewDataFoundLength>AcquisitionBufferSpaceLeftThisBuffer)
         %repstosb=1;
         %Destination1=AcquisitionBufferNextWrittenElemen:Init_Vars.BufferSize;
         %From1=1:AcquisitionBufferSpaceLeftThisBuffer;
         %Destination2=1:(NewDataFoundLength-AcquisitionBufferSpaceLeftThisBuffer);
         %From2=(AcquisitionBufferSpaceLeftThisBuffer+1):NewDataFoundLength;

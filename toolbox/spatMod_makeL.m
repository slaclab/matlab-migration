function maskL=spatMod_makeL(parameters)
...
% thick=3;%this can be changed
%this makes a normal L
%the horizontal line
...
%for j=dmd1*(frac1-1)/(2*frac1)+1+500:dmd1*(frac1-1)/(2*frac1)+verLen+500
...
%figure(1);imagesc(maskL);title('DMD image');

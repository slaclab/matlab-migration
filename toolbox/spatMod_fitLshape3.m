function [cameraL,outputs]=spatMod_fitLshape3(handles, parameters)
...
% /usr/local/lcls/tools/matlab/toolbox/images/cameraL=imread('cameraL','bmp');
...
ratio1=long/(dmd1/frac1);
ratio2=short/(dmd2/frac2);
%-------------------------------------------------------------------------------------

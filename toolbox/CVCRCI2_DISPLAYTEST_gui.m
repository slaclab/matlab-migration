function varargout = CVCRCI2_DISPLAYTEST_gui(varargin)
% CVCRCI2_DISPLAYTEST_GUI MATLAB code for CVCRCI2_DISPLAYTEST_gui.fig
%      CVCRCI2_DISPLAYTEST_GUI, by itself, creates a new CVCRCI2_DISPLAYTEST_GUI or raises the existing
%      singleton*.
%
%      H = CVCRCI2_DISPLAYTEST_GUI returns the handle to a new CVCRCI2_DISPLAYTEST_GUI or the handle to
%      the existing singleton*.
%
%      CVCRCI2_DISPLAYTEST_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CVCRCI2_DISPLAYTEST_GUI.M with the given input arguments.
%
%      CVCRCI2_DISPLAYTEST_GUI('Property','Value',...) creates a new CVCRCI2_DISPLAYTEST_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CVCRCI2_DISPLAYTEST_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CVCRCI2_DISPLAYTEST_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help CVCRCI2_DISPLAYTEST_gui

% Last Modified by GUIDE v2.5 28-Mar-2015 21:16:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CVCRCI2_DISPLAYTEST_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @CVCRCI2_DISPLAYTEST_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CVCRCI2_DISPLAYTEST_gui is made visible.
function CVCRCI2_DISPLAYTEST_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CVCRCI2_DISPLAYTEST_gui (see VARARGIN)

% Choose default command line output for CVCRCI2_DISPLAYTEST_gui
...
% UIWAIT makes CVCRCI2_DISPLAYTEST_gui wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CVCRCI2_DISPLAYTEST_gui_OutputFcn(hObject, eventdata, handles) 

    ...
    methods
        ...
        function conversionFuncs = getPropertyConversionFunctions(~)
            ...
            conversionFuncs = {...
                ...
                {'WindowStyle'        , CommonPropertyConversionUtil.reportUnsupportedPropertyIfValueIsNot('normal', AppConversionIssueFactory.Ids.UnsupportedPropertyWithNoWorkaround)},...
                };

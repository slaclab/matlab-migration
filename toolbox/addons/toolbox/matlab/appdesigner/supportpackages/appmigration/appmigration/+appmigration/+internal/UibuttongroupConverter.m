classdef UibuttongroupConverter < appmigration.internal.ComponentConverter
    %   UIBUTTONGROUPCONVERTER Converts a uibuttongroup to equivalent App Designer
    %   component.
    ...
    methods
        function [componentCreationFunction, issues] = getComponentCreationFunction(~, guideComponent)
            ...
            componentCreationFunction = @uibuttongroup;
            issues = [];
        end
        ...
        function conversionFuncs = getCallbackConversionFunctions(~, ~)
            ...
            conversionFuncs = {...
                ...
                {'SelectionChangedFcn'  , @CommonCallbackConversionUtil.convertOneToOneCallback},...
                };
        end

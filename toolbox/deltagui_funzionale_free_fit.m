function OUT=deltagui_funzionale_free_fit(DeltaZ,FreeFit,SearchDestination)
...
OUT = (SearchDestination(1)-B13).^2 + (SearchDestination(2)-B24).^2 + (SearchDestination(3)-Phase).^2;

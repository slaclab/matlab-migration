function img_out=spatMod_imageresize(img_in, rowScale, colScale)
...
%            imoutL = spatMod_imageresize(imin, 2, 2); % enlarge image
%            imoutS = spatMod_imageresize(imin, 0.2, 0.2) % shrink image
%

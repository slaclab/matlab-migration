...
function out = multi_oy_LTU1490(in)
persistent initial_vals

% in.knob is the number entered into the knob
% ENTER THE PVS YOU WANT TO CONTROL. 
out.pvs{1,1} = 'YCOR:LTU1:453:BCTRL';
out.pvs{2,1} = 'YCOR:LTU1:493:BCTRL';
out.pvs{3,1} = 'YCOR:LTU1:563:BCTRL';
out.pvs{4,1} = 'SIOC:SYS0:ML00:AO077';
out.num_pvs = 4; % ENTER NUMBER OF PVs
out.egu = 'um'; % engineering units for knob (display only)

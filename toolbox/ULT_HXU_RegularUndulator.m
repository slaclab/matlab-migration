function varargout = ULT_HXU_RegularUndulator(varargin)
% ULT_HXU_REGULARUNDULATOR MATLAB code for ULT_HXU_RegularUndulator.fig
%      ULT_HXU_REGULARUNDULATOR, by itself, creates a new ULT_HXU_REGULARUNDULATOR or raises the existing
%      singleton*.
%
%      H = ULT_HXU_REGULARUNDULATOR returns the handle to a new ULT_HXU_REGULARUNDULATOR or the handle to
%      the existing singleton*.
%
%      ULT_HXU_REGULARUNDULATOR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ULT_HXU_REGULARUNDULATOR.M with the given input arguments.
%
%      ULT_HXU_REGULARUNDULATOR('Property','Value',...) creates a new ULT_HXU_REGULARUNDULATOR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ULT_HXU_RegularUndulator_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ULT_HXU_RegularUndulator_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ULT_HXU_RegularUndulator

% Last Modified by GUIDE v2.5 16-Jun-2020 11:23:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ULT_HXU_RegularUndulator_OpeningFcn, ...
                   'gui_OutputFcn',  @ULT_HXU_RegularUndulator_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ULT_HXU_RegularUndulator is made visible.
function ULT_HXU_RegularUndulator_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ULT_HXU_RegularUndulator (see VARARGIN)

% Choose default command line output for ULT_HXU_RegularUndulator
...
% UIWAIT makes ULT_HXU_RegularUndulator wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ULT_HXU_RegularUndulator_OutputFcn(hObject, eventdata, handles) 

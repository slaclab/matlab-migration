...
if(Initialize)
    ...
    if(isequal(CurrentDataStructure,StrutturaDatiFull))
        ...
        if((get(MyHandle.V_SEL,'value') > numel(LIST_OF_VECTORS)) || (numel(LIST_OF_VECTORS)>1) )
            set(MyHandle.V_SEL,'value',numel(LIST_OF_VECTORS));
            VAL=numel(LIST_OF_VECTORS);
            if(VAL==1)
               petizione.V_SEL=[0,0];
            else
        ...
        set(MyHandle.WritePVs,'value',petizione.Write)
    end
else
    petizione=get(MyHandle.IdatiStanQua,'userdata'); 
    ...
    if(SynchMode==1)
        ...
        if(isempty(TENUTI) || (~petizione.V_SEL(1)))
            if(petizione.MomentsON )
                ...
                if(petizione.Write)
                  lcaPutSmart('SIOC:SYS0:ML03:AO307',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO308',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO312',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO313',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO317',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO318',NaN);
                end
            end
            if(petizione.FWHMON )
                DATAMATRIX{3,1}=NaN;DATAMATRIX{3,2}=NaN;DATAMATRIX{3,3}=NaN;
                if(petizione.Write)
                  lcaPutSmart('SIOC:SYS0:ML03:AO309',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO314',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO319',NaN);
                end
            end
            if(petizione.PEAKON )
                ...
                if(petizione.Write)
                  lcaPutSmart('SIOC:SYS0:ML03:AO310',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO315',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO320',NaN);
                end
            end
            ...
            if(petizione.S1)
                ...
                if(petizione.Write)
                  lcaPutSmart('SIOC:SYS0:ML03:AO301',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO304',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO305',NaN);
                end
            end
            if(petizione.S2)
                THREEBYTHREE{2,1}=NaN;THREEBYTHREE{2,2}=NaN;THREEBYTHREE{2,3}=NaN;
                if(petizione.Write)
                  lcaPutSmart('SIOC:SYS0:ML03:AO302',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO304',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO306',NaN);
                end
            end
            if(petizione.S3)
                THREEBYTHREE{3,1}=NaN;THREEBYTHREE{3,2}=NaN;THREEBYTHREE{3,3}=NaN;
                if(petizione.Write)
                  lcaPutSmart('SIOC:SYS0:ML03:AO303',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO305',NaN);
                  lcaPutSmart('SIOC:SYS0:ML03:AO306',NaN);
                end
            end
        ...
        if(petizione.ShowAVGON) %Plot Average on Filtered
            ...
            if(petizione.MomentsON)
                 ...
                 if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO307',DATAMATRIX{1,1});
                   lcaPutSmart('SIOC:SYS0:ML03:AO308',DATAMATRIX{2,1});
                 end
            end
            if(petizione.FWHMON)
                [MA,MB]=max(MEDIA);
                ...
                DATAMATRIX{3,1}=FWHM;
                if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO309',DATAMATRIX{3,1});
                end
            end
            if(petizione.PEAKON)
                [MA,MB]=max(MEDIA);
                ...
                DATAMATRIX{4,1}=MA;
                if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO310',DATAMATRIX{4,1});
                   lcaPutSmart('SIOC:SYS0:ML03:AO311',DATAMATRIX{5,1});
                end
            end
        end
        if(petizione.ShowAVGLASTON)  %Plot Average on Filtered and last...
            ...
            if(petizione.MomentsON)
                ...
                if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO312',DATAMATRIX{1,2});
                   lcaPutSmart('SIOC:SYS0:ML03:AO313',DATAMATRIX{2,2});
                end
            end
            if(petizione.FWHMON)
                [MA,MB]=max(MEDIA);
                ...
                DATAMATRIX{3,2}=FWHM;
                if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO314',DATAMATRIX{3,2});
                end
            end
            if(petizione.PEAKON)
                [MA,MB]=max(MEDIA);
                ...
                DATAMATRIX{4,2}=MA;
                if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO315',DATAMATRIX{4,2});
                   lcaPutSmart('SIOC:SYS0:ML03:AO316',DATAMATRIX{5,2});
                end
            end
        end
...
%                 save TEMPOREX
            ...
            if(petizione.MomentsON)
                ...
                if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO317',DATAMATRIX{1,3});
                   lcaPutSmart('SIOC:SYS0:ML03:AO318',DATAMATRIX{2,3});
                end
            end
            if(petizione.FWHMON)
                [MA,MB]=max(MEDIA);
                ...
                DATAMATRIX{3,3}=FWHM;
                if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO319',DATAMATRIX{3,3});
                end
            end
            if(petizione.PEAKON)
                [MA,MB]=max(MEDIA);
                ...
                DATAMATRIX{4,3}=MA;
                if(petizione.Write)
                   lcaPutSmart('SIOC:SYS0:ML03:AO320',DATAMATRIX{4,3});
                   lcaPutSmart('SIOC:SYS0:ML03:AO321',DATAMATRIX{5,3});
                end
            end
        end
        set(MyHandle.RT,'data',DATAMATRIX)
        ...
        if(petizione.S1)
           ...
           THREEBYTHREE{1,1}=S1;
           if(petizione.Write)
                 lcaPutSmart('SIOC:SYS0:ML03:AO301',S1);
           end
        end
        if(petizione.S2)
           ...
           THREEBYTHREE{2,2}=S2;
           if(petizione.Write)
                 lcaPutSmart('SIOC:SYS0:ML03:AO302',S2);
           end
        end
        if(petizione.S3)
           ...
           THREEBYTHREE{3,3}=S3;
           if(petizione.Write)
                 lcaPutSmart('SIOC:SYS0:ML03:AO303',S3);
           end
        end
        if(petizione.S1 && petizione.S2)
            ...
            if(petizione.Write)
                 lcaPutSmart('SIOC:SYS0:ML03:AO304',THREEBYTHREE{1,2});
            end
        end
        if(petizione.S1 && petizione.S3)
            ...
            if(petizione.Write)
                 lcaPutSmart('SIOC:SYS0:ML03:AO305',THREEBYTHREE{1,3});
            end
        end
        if(petizione.S2 && petizione.S3)
            ...
            if(petizione.Write)
                 lcaPutSmart('SIOC:SYS0:ML03:AO306',THREEBYTHREE{2,3});
            end
        end
        set(MyHandle.STABLE,'data',THREEBYTHREE);
        ...
        if(petizione.FourierAnalysis)
           if(~isempty(TENUTI));
              SumEne1=zeros(size(ProfileBuffer{petizione.V_SEL(2)}(TENUTI(1),:)));
              SumEne2=SumEne1;
              for AK=1:length(TENUTI)      
                    ThisFFT=fft(ProfileBuffer{petizione.V_SEL(2)}(TENUTI(AK),:) - mean(ProfileBuffer{petizione.V_SEL(2)}(TENUTI(AK),:)));
                    ThisFFTENE1=abs(ThisFFT);
                    ThisFFTENE2=abs(ThisFFT);
                    SumEne1=SumEne1+ThisFFTENE1;
                    SumEne2=SumEne2+ThisFFTENE2;
              end
              SumEne1=SumEne1/AK;
              SumEne2=SumEne2/AK;
           end
           planckh=4.1356675191*10^-15;
           DeltaOmega=2*pi*abs((ASSE(2)-ASSE(1)))/planckh;
           TMAX=1/DeltaOmega/2;
           TEFF=TMAX/2;
           NotAliasingArea=round(length(ASSE)/2);
           ASSE_X=linspace(0,TEFF,NotAliasingArea);
           figure(147)
           plot(ASSE_X,SumEne1);
           figure(148)
           plot(ASSE_X,SumEne2);
    ...
    if(petizione.logbook_and_save || petizione.logbook_only)
       ...
       TEMPLABEL=ylabel(CHILDREN(1),'Spectral intensity [Arb. Units]');

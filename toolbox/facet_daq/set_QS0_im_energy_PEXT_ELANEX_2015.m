function [BDES, BACT] = set_QS0_im_energy_PEXT_ELANEX_2015(E)
...
if E<(-27.4-20.35) || E>(27.4-20.35)
    disp(sprintf('\nThis value is not permitted.\n'));
else
    disp(sprintf('\nSetting QS quads to the requested imaged energy.\n'));
    VAL = (1+E/20.35)*[-155.20, 285.58, -173.19]; % QS0 config for 20.35 GeV from MIP to ELANEX, Feb 2015

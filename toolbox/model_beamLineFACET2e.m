...
[FACET2E,FACET2S,INJ,INJS10AIP]=bl();
beamLine.F2_S10AIP=[INJS10AIP]';
...
function [FACET2E,FACET2S,INJ,INJS10AIP]=bl()
...
L0AF=[L0AFBEG,FLNGAF1,L0AF__1,DLFDAF,L0AF__2,L0AF__3,SC2F,L0AF__4,L0AFMID,L0AF__5,L0AF__6,OUTCPAF,L0AF__7,FLNGAF2,L0AFWAKE,L0AFEND];
L0BF=[L0BFBEG,FLNGBF1,L0BF__1,DLFDBF,L0BF__2,SC4F,L0BF__3,L0BFMID,L0BF__4,SC5F,L0BF__5,OUTCPBF,L0BF__6,FLNGBF2,L0BFWAKE,L0BFEND];
...
INJ=[DL00,LOADLOCKF,BEGINJ,SOL10111,CATHODEF,DL01A,SOL10121_FULL,DL01B,VV10155,DL01C,MIR10181,DL01D,VV10215,DL01E,BPM10221,DL01F,SC1F,DL01G,PR10241,DL01H,L0AF,DL02,QA10361_FULL,DL03A,PH10365,DL03B,QA10371_FULL,DL04,L0BF,ENDINJ];
...
BX10661A={'be' 'BX10661' LB0/2 [AB0/2 GB0/2 AB0/2 0 0.45 0 0]}';
BX10661B={'be' 'BX10661' LB0/2 [AB0/2 GB0/2 0 AB0/2 0 0.45 0]}';
BX10751A={'be' 'BX10751' LB0/2 [AB0/2 GB0/2 AB0/2 0 0.45 0 0]}';
BX10751B={'be' 'BX10751' LB0/2 [AB0/2 GB0/2 0 AB0/2 0 0.45 0]}';
% define unsplit SBENs for BMAD ... not used by MAD
BX10661={'be' 'BX1066' LB0 [AB0 GB0/2 AB0/2 AB0/2 0.45 0.45 0]}';
BX10751={'be' 'BX1075' LB0 [AB0 GB0/2 AB0/2 AB0/2 0.45 0.45 0]}';
% ==============================================================================
% MATR
% ------------------------------------------------------------------------------
...
% QUAD
% ------------------------------------------------------------------------------
% match around laser heater (not installed)
KQE10425 =  -15.201903779328;
KQE10441 =   14.620018144249;
KQE10511 =   10.3685858706;
KQE10525 =  -10.475280419976;
% match to BC11CEND (X-band not installed)
KQM10631 =   11.990887883552;
KQM10651 =  -11.233494237683;
KQB10731 =   22.169701529671;
KQM10771 =   -7.123593114848;
KQM10781 =   11.698487496707;
...
%  SQ11340 : QUAD, TYPE="1.69Q3.4",   L=LQc/2, APER=rQc, K1=KSQ11340, TILT - removed Feb-28-2020
...
DM11={'dr' '' 0.533689514667 []}';%0.53309
DM12={'dr' '' 0.128601 []}';%0.128001
D11OA={'dr' '' LD11A/cos(AB11) []}';
D11OB={'dr' '' LD11B/cos(AB11) []}';
D11OC={'dr' '' LD11C/cos(AB11) []}';
DDG11={'dr' '' 0.24864 []}';
DDG12={'dr' '' 0.16446 []}';
DDG13={'dr' '' 0.182606 []}';
DDG14={'dr' '' 0.234494 []}';
D11OD={'dr' '' LD11D/cos(AB11) []}';
D11OD1={'dr' '' 0.131230935728 []}';
D11OD2={'dr' '' D11OD{3}-D11OD1{3} []}';
D11OE={'dr' '' LQC+LD11E/cos(AB11) []}';
D11OF={'dr' '' LD11F/cos(AB11) []}';
D11OG={'dr' '' LD11G/cos(AB11) []}';
DM13A={'dr' '' 0.161725 []}';
DM13B={'dr' '' 0.162325 []}';%0.161725
DM14A={'dr' '' 0.384724 []}';%0.384124
DM14B={'dr' '' 0.17946475 []}';%0.17886475
...
% collimators
% ------------------------------------------------------------------------------
CE11345={'dr' 'CE11345' 0 []}';%energy collimator
% ==============================================================================
% MARK
% ------------------------------------------------------------------------------
...
BC11C=[BC11CBEG,BCX11314_FULL,D11OA,CQ11317_FULL,D11OB,YC11321,D11OC,BCX11331_FULL,DDG11,BPM11333,DDG12,DDG13,PR11335,DDG14,BCX11338_FULL,D11OD1,CE11345,D11OD2,D11OE,D11OF,CQ11352_FULL,D11OG,BCX11355_FULL,CNT1B,BC11CEND];
...
BC11_2=[BEGBC11_2,DM13A,DM13B,QM11358_FULL,DM14A,BL11359,IM11360,DM14B,QM11362_FULL,DM15A,YC11365,DM15B,PR11375,DM15C,TD11390,DM15D,QM11393_FULL,DM16A,DM16B,Q11401_FULL,DM17,ENDBC11_2];
BC11=[BC11_1,BC11_2];
% ==============================================================================
...
K14_6D1={'lc' 'K14_6D' 2.3321 [SBANDF P25*G14_6*2.3321 PHIL2*TWOPI]}';
K14_6D2={'lc' 'K14_6D' 0.3048 [SBANDF P25*G14_6*0.3048 PHIL2*TWOPI]}';
K14_6D3={'lc' 'K14_6D' 0.4072 [SBANDF P25*G14_6*0.4072 PHIL2*TWOPI]}';
% define unsplit LCAVs for BMAD ... not used by MAD
...
D21OA={'dr' '' ZD21OA/cos(AB14) []}';
DDG0={'dr' '' 0.131153711244 []}';%0.131185
DDG21={'dr' '' 0.24864 []}';
DDG22A={'dr' '' 0.08223 []}';
DDG22B={'dr' '' 0.08223 []}';
DDG23={'dr' '' 0.182606 []}';
DDG24={'dr' '' 0.234494 []}';
DDGA={'dr' '' 0.13118372 []}';%0.131215
D210B1={'dr' '' ZD210B1/cos(AB14) []}';
D210B1_A={'dr' '' ZD210B1_A/cos(AB14) []}';
D210B2={'dr' '' ZD210B2/cos(AB14) []}';
D210B={'dr' '' ZD210B/cos(AB14) []}';
D210B_A={'dr' '' ZD210B_A/cos(AB14) []}';
DBQ2B={'dr' '' ZDBQ2B/cos(AB14) []}';
DM23A={'dr' '' 0.513165382243 []}';%0.304465382243+0.2087
DM23B={'dr' '' 0.114235 []}';
DM23C={'dr' '' 0.227465 []}';
DM24={'dr' '' 0.5552 []}';%0.3065+0.178+0.0707
DM24A={'dr' '' 0.3065 []}';
DM24B={'dr' '' DM24{3}-DM24A{3} []}';
DM25={'dr' '' 0.3735 []}';
% ==============================================================================
% XCORs and YCORs
% ------------------------------------------------------------------------------
...
% positron
CE141802={'dr' 'CE141802' 0 []}';%energy collimator
% ==============================================================================
% vacuum valves
% ------------------------------------------------------------------------------
VV14711={'mo' 'VV14711' 0 []}';%BC14 upstream vacuum valve
VV14885={'mo' 'VV14885' 0 []}';%BC14 downstream vacuum valve
% ==============================================================================
% MARK
% ------------------------------------------------------------------------------
...
BC14E=[BEGBC14E,BCX14720_FULL,DBQ2A,CQ14738_FULL,D210B_A,YC14780,D210B1_A,BCX14796_FULL,DDG0,DDG21,BPM14801,DDG22A,DDG22B,DDG23,PR14803,DDG24,DDGA,BCX14808_FULL,D210B1,CE14815,D210B2,D210B,CQ14866_FULL,DBQ2B,BCX14883_FULL,ENDBC14E];
...
BC14P=[BEGBC14P,BCX141720_FULL,DBQ2A,CQ141738_FULL,D21OA,BCX141796_FULL,DDG0,DDG21,BPM141801,DDG22A,DDG22B,DDG23,PR141803,DDG24,DDGA,BCX141808_FULL,D210B1,CE141802,D210B2,YC141820,D210B,CQ141866_FULL,DBQ2B,BCX141883_FULL,ENDBC14P];
...
G19_5 =  GRADFB3 ;
G19_6 =  GRADFB3;
K15_1A1={'lc' 'K15_1A' 0.33 [SBANDF P25*G15_1*0.33 PHIL3*TWOPI]}';
K15_1A2={'lc' 'K15_1A' 0.25 [SBANDF P25*G15_1*0.25 PHIL3*TWOPI]}';
K15_1A3={'lc' 'K15_1A' 2.4641 [SBANDF P25*G15_1*2.4641 PHIL3*TWOPI]}';
...
KQ15201 =   0.683413636633;
KQ15301 =  -0.845262147155;
KQ15401 =   0.675642032342;
KQ15501 =  -0.364291147505;
KQ15601 =   0.338793929142;
...
KQ19201 =   0.836411275054;
KQ19301 =  -0.933653738427;
KQ19401 =   0.833761518539;
KQ19501 =  -1.022643707024 ;%-0.77122157 ... scavenger extraction
KQ19601 =   0.757743409798 ;% 0.77143041 ... scavenger extraction
KQ19701 =  -0.749406010373 ;%-0.7786437  ... scavenger extraction
KQ19801 =   1.000000914904;
KQ19851 =  -1.749500861406 ;%new
KQ19871 =   1.174163314925 ;%new
...
D199A1={'dr' '' 0.8016 []}';
D199A2={'dr' '' 0.32 []}';
D199A={'dr' '' 5.4757-0.32 []}';
D199B={'dr' '' 2.0867 []}';%26238214
D199C={'dr' '' 4.570884 []}';
D199D={'dr' '' LMDW-(DAQ2{3}+4*DLWL10+DAQ1{3}+LQE+DAQ2{3}+DLWL10+3.2062+LQE+2.0867+LQE+D199C{3}) []}';
% ==============================================================================
% XCORs and YCORs
% ------------------------------------------------------------------------------
...
LI19C=[DAQ2,D19_7,DAQ1,Q19801_FULL,D199A1,XC19900,D199A2,YC19900,D199A,Q19851_FULL,D199B,Q19871_FULL,D199C,IM1988,D199D,LI19TERM];
...
WIGE_FULL=[WIGE11,WIGE12,DWE,WIGE21,YCWIGE,WIGE22,DWE,WIGE31,WIGE32];
Q1EL_FULL=[Q1EL,Q1EL];
SQ1_FULL=[SQ1,SQ1];
Q2EL_FULL=[Q2EL,Q2EL];

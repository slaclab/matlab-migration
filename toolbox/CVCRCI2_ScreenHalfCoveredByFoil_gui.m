function varargout = CVCRCI2_ScreenHalfCoveredByFoil_gui(varargin)
% CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI MATLAB code for CVCRCI2_ScreenHalfCoveredByFoil_gui.fig
%      CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI, by itself, creates a new CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI or raises the existing
%      singleton*.
%
%      H = CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI returns the handle to a new CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI or the handle to
%      the existing singleton*.
%
%      CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI.M with the given input arguments.
%
%      CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI('Property','Value',...) creates a new CVCRCI2_SCREENHALFCOVEREDBYFOIL_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CVCRCI2_ScreenHalfCoveredByFoil_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CVCRCI2_ScreenHalfCoveredByFoil_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help CVCRCI2_ScreenHalfCoveredByFoil_gui

% Last Modified by GUIDE v2.5 08-May-2015 21:12:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CVCRCI2_ScreenHalfCoveredByFoil_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @CVCRCI2_ScreenHalfCoveredByFoil_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CVCRCI2_ScreenHalfCoveredByFoil_gui is made visible.
function CVCRCI2_ScreenHalfCoveredByFoil_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CVCRCI2_ScreenHalfCoveredByFoil_gui (see VARARGIN)

% Choose default command line output for CVCRCI2_ScreenHalfCoveredByFoil_gui
...
petizione.S2=1;
petizione.S3=0;
petizione.S1MASK=[153,173];
petizione.S2MASK=[100,120];
...
% UIWAIT makes CVCRCI2_ScreenHalfCoveredByFoil_gui wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CVCRCI2_ScreenHalfCoveredByFoil_gui_OutputFcn(hObject, eventdata, handles) 
...
function CABET_Callback(hObject, eventdata, handles)
petizione=get(handles.IdatiStanQua,'Userdata');
newval=str2double(get(handles.CABET,'string'));
if(isinf(newval)), newval=0.4; end
if(isnan(newval)), newval=0.4; end
newval=round(newval);
if((newval>1) || (newval<0)), newval=0.4; set(handles.CABET,'string',num2str(newval));end
petizione.CABET=newval;
set(handles.IdatiStanQua,'Userdata',petizione);


% --- Executes during object creation, after setting all properties.
function CABET_CreateFcn(hObject, eventdata, handles)
% hObject    handle to CABET (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function UABET_Callback(hObject, eventdata, handles)
petizione=get(handles.IdatiStanQua,'Userdata');
newval=str2double(get(handles.UABET,'string'));
if(isinf(newval)), newval=1; end
if(isnan(newval)), newval=1; end
newval=round(newval);
if((newval>1) || (newval<0)), newval=1; set(handles.UABET,'string',num2str(newval));end
petizione.UABET=newval;
set(handles.IdatiStanQua,'Userdata',petizione);

% --- Executes during object creation, after setting all properties.
function UABET_CreateFcn(hObject, eventdata, handles)
% hObject    handle to UABET (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function CAAET_Callback(hObject, eventdata, handles)
petizione=get(handles.IdatiStanQua,'Userdata');
newval=str2double(get(handles.CAAET,'string'));
if(isinf(newval)), newval=0.4; end
if(isnan(newval)), newval=0.4; end
newval=round(newval);
if((newval>1) || (newval<0)), newval=0; set(handles.CAAET,'string',num2str(newval));end
petizione.CAAET=newval;
set(handles.IdatiStanQua,'Userdata',petizione);


% --- Executes during object creation, after setting all properties.
function CAAET_CreateFcn(hObject, eventdata, handles)
% hObject    handle to CAAET (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function UAAET_Callback(hObject, eventdata, handles)
petizione=get(handles.IdatiStanQua,'Userdata');
newval=str2double(get(handles.UAAET,'string'));
if(isinf(newval)), newval=1; end
if(isnan(newval)), newval=1; end
newval=round(newval);
if((newval>1) || (newval<0)), newval=1; set(handles.UAAET,'string',num2str(newval));end
petizione.UAAET=newval;
set(handles.IdatiStanQua,'Userdata',petizione);


% --- Executes during object creation, after setting all properties.
function UAAET_CreateFcn(hObject, eventdata, handles)
% hObject    handle to UAAET (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

...
function out = LEB_BakeGuardian()
disp('LEB_BakeGuardian.m 10/26/2018 v1.02');
%
%
%
global DISABLE_TRIP;
...
%
delay = 0.5; % loop rate
watchdog_pv = 'SIOC:SYS2:ML00:AO049';%check this
...
%
%Fixed-name PVs here...
L.error_string_pv = 'SIOC:SYS2:ML00:CA003';
%
n = n + 1;
...
%
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO001');
L.AnyRTDHigh_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO002');
L.RFWindowsHigh_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO003');
L.GunVacHigh_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO004');
L.SprinklerHigh_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO005');
L.CuSSdeltaTHigh_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO006');
L.SolnBuckHigh_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO007');
L.GateValveHigh_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO008');
L.Future1High_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO009');
L.Future2High_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO010');
L.UseXIG_n = n;
n = n + 1;
L.pv{n,1} = ('SIOC:SYS2:ML00:AO015');
...
pvname = ['SIOC:SYS2:ML00:AO', numstr];

...
%   Retrieved from Matlab File Exchange August 2016
%   Added Sep 29, 2016, Tim Maxwell
%==============================================================================

% Check if POI libs are loaded
if exist('org.apache.poi.ss.usermodel.WorkbookFactory', 'class') ~= 8 ...
    ...
    hotliblocation = '/usr/local/lcls/tools/matlab/javalib/';
    try
        javaaddpath([hotliblocation 'poi-3.8-20120326.jar']);
        javaaddpath([hotliblocation 'poi-ooxml-3.8-20120326.jar']);
        javaaddpath([hotliblocation 'poi-ooxml-schemas-3.8-20120326.jar']);
        javaaddpath([hotliblocation 'xmlbeans-2.3.0.jar']);
        javaaddpath([hotliblocation 'dom4j-1.6.1.jar']);
        javaaddpath([hotliblocation 'stax-api-1.0.1.jar']);
    catch

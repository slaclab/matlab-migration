function [q,dq,chisq,rms,covmat]=noplot_polyfit(x,y,dy,n)
%===============================================================================
%
% [q,dq,chisq,rms,covmat]=noplot_polyfit(x,y,dy,n);
%                                   
...
if (bars)
  [yfit,dyfit,p1,dp1,chi2,covmat]=fit(Q,y,dy);
else

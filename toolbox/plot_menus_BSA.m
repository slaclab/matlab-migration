...
function dataExport(hObject,eventdata,varargin)

util_printLog(gcf,'title','BSA');
[hObject,handles]=util_appFind('BSA_GUI');
BSA_GUI('save_data_button_Callback',handles.save_data_button,[],handles);
